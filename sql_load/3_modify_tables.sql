...
COPY company_dim
FROM 'C:\Users\saadb\Desktop\Databases\SQL_project_data_job_analysis\sql_data\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\Users\saadb\Desktop\Databases\SQL_project_data_job_analysis\sql_data\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\saadb\Desktop\Databases\SQL_project_data_job_analysis\sql_data\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\saadb\Desktop\Databases\SQL_project_data_job_analysis\sql_data\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
